...
function Footer({ className }: FooterProps) {
  return (
    <footer
      className={cn("border-t border-border bg-deep-plum", className)}
    >
      <div className="mx-auto max-w-[var(--max-width-site)] px-[var(--spacing-section-x)] py-24">
        <div className="grid grid-cols-1 gap-16 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="max-w-xs text-[length:var(--font-size-body)] leading-relaxed text-neutral-white/60">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex size-10 items-center justify-center rounded-sm border border-neutral-white/20 text-neutral-white transition-colors hover:border-neutral-white/40 hover:bg-neutral-white/10"
              >
          ...
          <div className="flex flex-col gap-5">
            <span className="text-[length:var(--font-size-overline)] font-[40] uppercase tracking-widest text-neutral-white/50">
              Navigace
            </span>
      ...
      <div className="border-t border-neutral-white/10">
        <div className="mx-auto flex max-w-[var(--max-width-site)] flex-wrap items-center justify-between gap-4 px-[var(--spacing-section-x)] py-5">
          <div className="flex flex-wrap items-center gap-2 text-[length:var(--font-size-body-sm)] text-neutral-white/40">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-2 transition-colors hover:text-neutral-white/70"
            >
              pohrebpegas.cz
            </a>
          </div>
          <span className="text-[length:var(--font-size-body-sm)] text-neutral-white/30">
