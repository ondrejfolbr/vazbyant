          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex size-9 items-center justify-center rounded-sm border border-deep-plum-80/30 text-foreground transition-colors hover:border-deep-plum hover:bg-deep-plum hover:text-neutral-white"
              >
