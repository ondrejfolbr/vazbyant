  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "group/accordion-trigger flex flex-1 items-center justify-between gap-4 px-5 py-4 text-left font-heading text-[length:var(--font-size-body)] font-medium text-foreground transition-all outline-none hover:bg-deep-plum-10 focus-visible:ring-2 focus-visible:ring-plum-50/30 disabled:pointer-events-none disabled:opacity-50",
          className,
        )}
        {...props}
      >
